...
class YahooHeavyApi(ApiBase):
    def __init__(self):
        """
            Initialising attributes specific to Google API
            http://chartapi.finance.yahoo.com/instrument/1.0/TCS.NS/chartdata;type=quote;range=1d/json/
        """
        self.url_endpoint = 'http://chartapi.finance.yahoo.com/instrument/1.0/'
        self.batch_size = 20
        self.method = 'GET'
